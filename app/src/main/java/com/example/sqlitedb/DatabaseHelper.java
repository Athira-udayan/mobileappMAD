...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    {
        db.execSQL("create table " + TABLE_NAME + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME TEXT, COMPANY TEXT, DESIGNATION TEXT," + "PHNO INTEGER)");
    }
    ...
    public boolean insertData(String name, String company, String designation, String phone)
    {
